...
<br/>
	<div class="container">
		...
		<div class="panel-heading">
			...
			<h4 id="nombre_formulario">Pedidos</h4>
		</div>
			<div class="panel-body" >
					...
					<form class="form-horizontal" role="form" id="pedidos">
						...
						<div class="form-group row">						
							...
							<div class="col-md-1">
								<a href="ver_facturas.php?action=pedidos" class="btn btn-default" id="n_pedido"><i class="glyphicon glyphicon-plus"> </i> Nuevo</a>
							</div>
							
							<div class="col-md-1">
								<a href="#" class="btn btn-default" id="btn_precios" onclick="busca_listas('1')" onkeydown="onKeyDownHandler(event);"><i class="glyphicon glyphicon-edit"> </i> Lista de precios</a>
							</div>		
